...
void __set_pwm_freq(int f) {
    ...
    int PR2_value = (int) ((PWM_PERIOD * 16000000) / (4 * 16) - 1);
...
void __set_duty_cycle(int duty_cycle) {
    ...
    uint8_t reg_value = (uint8_t) ((dc_period * 16000000) / 16);
...
void main(void) {
    ...
    while (1) {
        float adc_value = (float) __adc_read(1);
        int pwm_value = (int) (adc_value * 100) / 1023;
